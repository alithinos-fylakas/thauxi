...
class Level:
    def __init__(self, currentLevel, size):
        ...
        # Decoration
        self.image_decoration = pygame.image.load("../graphics/decoration/vincentiu-solomon-ln5drpv_ImI-unsplash.jpg").convert()
        ...
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                ...
                if val == "0":
                    ...
                    self.spawn_y = y
                if val == "1":
                    end_surface = pygame.image.load("../graphics/character/end_thing.png").convert_alpha()
            ...
            for col_index, val in enumerate(row):
                if val != "-1":
                    ...
                    match type:
                        ...
                        case "Background2":
                            Background2_tile_list = import_cut_graphics("../graphics/terrain/props2.png")
                            tile_surface = Background2_tile_list[int(val)]
                            sprite = tiles.StaticBlock((tile_size, tile_size), x, y, tile_surface)

                        case "Background1":
                            Background1_tile_list = import_cut_graphics("../graphics/terrain/props2.png")
                            tile_surface = Background1_tile_list[int(val)]
                            sprite = tiles.StaticBlock((tile_size, tile_size), x, y, tile_surface)
                        
                        case "sides2":
                            sides2_tile_list = import_cut_graphics("../graphics/terrain/props1.png")
                            tile_surface = sides2_tile_list[int(val)]
                            sprite = tiles.StaticBlock((tile_size, tile_size), x, y, tile_surface)
                        
                        case "sides1":
                            sides1_tile_list = import_cut_graphics("../graphics/terrain/props1.png")
                            tile_surface = sides1_tile_list[int(val)]
                            sprite = tiles.StaticBlock((tile_size, tile_size), x, y, tile_surface)
                        
                        case "upsidedown2":
                            upsidedown_2_tile_list = import_cut_graphics("../graphics/terrain/props1.png")
                            tile_surface = upsidedown_2_tile_list[int(val)]
                            sprite = tiles.StaticBlock((tile_size, tile_size), x, y, tile_surface)
                        
                        case "upsidedown1":
                            upsidedown_1_tile_list = import_cut_graphics("../graphics/terrain/props1.png")
                            tile_surface = upsidedown_1_tile_list[int(val)]
                            sprite = tiles.StaticBlock((tile_size, tile_size), x, y, tile_surface)
                        
                        case "terrain":
                            terrain_tile_list = import_cut_graphics("../graphics/terrain/mainlev_build_v2.png")
                            tile_surface = terrain_tile_list[int(val)]
                            sprite = tiles.StaticBlock((tile_size, tile_size), x, y, tile_surface)

                        case "enemy":
                            sprite = Enemy(32, 64, x, y, "../graphics/enemy")
